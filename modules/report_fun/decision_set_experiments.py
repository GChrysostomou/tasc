    ...
    for dataset in datasets:
        ...
        for encoder in encoders:
            ...
            for mechanism in mechanisms:
                ...
                mech_temp[mechanism]["attn"] = round(nontasc["attention"],2)
                mech_temp[mechanism]["attn_grad"] = round(nontasc["attention gradients"],2)
                mech_temp[mechanism]["attn_gradattn"] = round(nontasc["scaled attention"],2)


                mech_temp[mechanism]["attn +"] = round(tasc["attention"],2)
                mech_temp[mechanism]["attn_grad +"] = round(tasc["attention gradients"],2)
                mech_temp[mechanism]["attn_gradattn +"] = round(tasc["scaled attention"],2)
...
def decision_set_experiments(results_dir , datasets,  encoders , mechanisms, tasc_approach):
